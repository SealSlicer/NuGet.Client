...
namespace NuGet.ProjectModel
{
    public class ProjectRestoreMetadata : IEquatable<ProjectRestoreMetadata>
    {
        ...
        /// </summary>
        public bool CentralPackageVersionOverrideEnabled { get; set; } = true;
        ...
        public override int GetHashCode()
        {
            ...
            hashCode.AddObject(CentralPackageVersionOverrideEnabled);
        ...
        public bool Equals(ProjectRestoreMetadata other)
        {
            ...
            return ProjectStyle == other.ProjectStyle &&
                   ...
                   EqualityUtility.EqualsWithNullCheck(CentralPackageVersionOverrideEnabled, other.CentralPackageVersionOverrideEnabled);
        }
        ...
        protected void FillClone(ProjectRestoreMetadata clone)
        {
            ...
            clone.CentralPackageVersionOverrideEnabled = CentralPackageVersionOverrideEnabled;
        }
    }
}
